    ...
    <Layout>
      ...
      <main>
        <section className='bg-[#151515] text-white'>
          ...
          <div className='z-10 flex flex-col overflow-hidden md:mx-20 md:h-screen md:flex-row md:gap-20 2xl:mx-60'>
            {/* Left  */}
            <div className='relative flex h-screen flex-col gap-10 md:w-2/5'>
              ...
              <div className='z-10 flex h-screen flex-col justify-center gap-5 px-4 md:relative md:my-28 md:justify-start md:gap-10'>
                ...
                <div>
                  <p>
                    I am Raymond Tetteh. A passionate software engineer based in
                    Ghana. I am a{' '}
                    <span className='font-bold underline'>self-taught</span>{' '}
                    developer for andn have been building stuff for over 3
                    years. I enjoy taking mobile apps and beautiful web
                    applications from design to a{' '}
            ...
            <div
              id='section-2'
              ref={ref}
              className='no-scrollbar z-10 flex flex-col gap-4 overflow-x-auto overflow-y-scroll px-4 py-40 pb-4 md:w-3/5 md:px-14 md:pb-40'
            >
              ...
              <div id='technologies' className='relative mt-40'>
                <div className='sticky top-0 left-0 right-0 py-5 uppercase tracking-widest shadow-md md:hidden'>
                  Technologies
                </div>
                <div className='flex-col gap-4 md:flex md:flex-row'>
                  <div className='mb-4 flex flex-col gap-4 px-2 md:w-1/2'>
                    <TechnologyCard
                      icon={
                        <svg
                          fill='#ffffff'
                    ...
                    {/* <TechnologyCard
                      ...
                      name='AWS'
                      desc='Experience with the AWS could ecosystem'
                      rating='4.0'
                    /> */}
                  </div>
                    ...
                    <TechnologyCard
                      icon={
                        <svg
                          ...
                          height='90px'
                        >
                          <path d='M 14.972656 1 A 1.0001 1.0001 0 0 0 14.173828 1.4375 L 6.1738281 13.167969 A 1.0001 1.0001 0 0 0 6.5527344 14.626953 L 14.552734 18.621094 A 1.0001 1.0001 0 0 0 15.447266 18.621094 L 23.447266 14.626953 A 1.0001 1.0001 0 0 0 23.826172 13.167969 L 15.826172 1.4375 A 1.0001 1.0001 0 0 0 14.972656 1 z M 15 3.7734375 L 15 11 L 21.519531 13.355469 L 15 16.609375 L 15 11 L 8.5761719 13.193359 L 15 3.7734375 z M 6.9628906 17 A 1.0001 1.0001 0 0 0 6.21875 18.625 L 14.21875 28.625 A 1.0001 1.0001 0 0 0 15.78125 28.625 L 23.78125 18.625 A 1.0001 1.0001 0 0 0 22.552734 17.105469 L 15 20.882812 L 7.4472656 17.105469 A 1.0001 1.0001 0 0 0 6.9628906 17 z M 10.626953 20.931641 L 14.552734 22.894531 A 1.0001 1.0001 0 0 0 15 23 L 15 26.398438 L 10.626953 20.931641 z' />
                        </svg>
                      }
                      name='Web3'
